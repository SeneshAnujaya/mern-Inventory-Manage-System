    ...
    <div className="flex justify-between items-center w-full mb-7">
      {/* {LEFT SIDE NAVBAR} */}
          ...
          <div className="relative">
            <input type="search" placeholder="Start type to search groups & product" className="pl-10 pr-4 py-2 w-50  md:w-60 border-2 border-gray-300 bg-white rounded-lg focus:border-blue-500" />
          ...
          <div className="flex justify-between items-center gap-5">
            <div className="hidden md:flex justify-between items-center gap-5">
              ...
              <div className="flex items-center gap-3 cursor-pointer">
                ...
                <span className="font-semibold">Senesh</span>
              </div>
            </div>
            <Link href="/settings">
